...
# ============================================
# POSTGRESQL DATA DIRECTORY RELOCATION TO /opt/lpdb/cloud/pg16/main
# ============================================
echo ""
echo "📁 PostgreSQL Data Directory Relocation"

PG_TARGET_DIR="${LEARNPLAY_PGDATA:-/opt/lpdb/cloud/pg16/main}"
...
echo ""
echo "Next steps:"
echo "  1. Transfer the dist-cloud package to $APP_DIR"
