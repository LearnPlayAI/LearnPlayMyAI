  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-3 sm:gap-4 border border-modal-border bg-modal text-modal-foreground shadow-dialog rounded-lg",
        "p-4 sm:p-6",
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold", sanitizePrimitiveClassNameStrict(className))}
    {...props}
  />
))
